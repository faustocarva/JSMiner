...
public interface JavaScriptParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code ClassElementMethodDefinition}
	 * labeled alternative in {@link JavaScriptParser#classElement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassElementMethodDefinition(JavaScriptParser.ClassElementMethodDefinitionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code ClassElementAssigment}
	 * labeled alternative in {@link JavaScriptParser#classElement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassElementAssigment(JavaScriptParser.ClassElementAssigmentContext ctx);
	/**
	 * Visit a parse tree produced by the {@code ClassElementEmptyStatment}
	 * labeled alternative in {@link JavaScriptParser#classElement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassElementEmptyStatment(JavaScriptParser.ClassElementEmptyStatmentContext ctx);
	/**
	 * Visit a parse tree produced by the {@code ClassElementProperty}
	 * labeled alternative in {@link JavaScriptParser#classElement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassElementProperty(JavaScriptParser.ClassElementPropertyContext ctx);
	/**
