...
public interface JavaScriptParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code ClassElementMethodDefinition}
	 * labeled alternative in {@link JavaScriptParser#classElement}.
	 * @param ctx the parse tree
	 */
	void enterClassElementMethodDefinition(JavaScriptParser.ClassElementMethodDefinitionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ClassElementMethodDefinition}
	 * labeled alternative in {@link JavaScriptParser#classElement}.
	 * @param ctx the parse tree
	 */
	void exitClassElementMethodDefinition(JavaScriptParser.ClassElementMethodDefinitionContext ctx);
	/**
	 * Enter a parse tree produced by the {@code ClassElementAssigment}
	 * labeled alternative in {@link JavaScriptParser#classElement}.
	 * @param ctx the parse tree
	 */
	void enterClassElementAssigment(JavaScriptParser.ClassElementAssigmentContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ClassElementAssigment}
	 * labeled alternative in {@link JavaScriptParser#classElement}.
	 * @param ctx the parse tree
	 */
	void exitClassElementAssigment(JavaScriptParser.ClassElementAssigmentContext ctx);
	/**
	 * Enter a parse tree produced by the {@code ClassElementEmptyStatment}
	 * labeled alternative in {@link JavaScriptParser#classElement}.
	 * @param ctx the parse tree
	 */
	void enterClassElementEmptyStatment(JavaScriptParser.ClassElementEmptyStatmentContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ClassElementEmptyStatment}
	 * labeled alternative in {@link JavaScriptParser#classElement}.
	 * @param ctx the parse tree
	 */
	void exitClassElementEmptyStatment(JavaScriptParser.ClassElementEmptyStatmentContext ctx);
	/**
	 * Enter a parse tree produced by the {@code ClassElementProperty}
	 * labeled alternative in {@link JavaScriptParser#classElement}.
	 * @param ctx the parse tree
	 */
	void enterClassElementProperty(JavaScriptParser.ClassElementPropertyContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ClassElementProperty}
	 * labeled alternative in {@link JavaScriptParser#classElement}.
	 * @param ctx the parse tree
	 */
	void exitClassElementProperty(JavaScriptParser.ClassElementPropertyContext ctx);
	/**
